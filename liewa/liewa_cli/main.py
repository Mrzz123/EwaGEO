...
from liewa.liewa_cli.utils import get_project_path, get_gui_config_path, get_user_data_path, save_image
...
def main():
    ...
    if args.config == "config1":
        ...
        args.config = get_gui_config_path()
        img = parse_image(args.config)
    ...
    if args.output is not None:
        ...
        file_name = os.path.join(get_user_data_path(), "backgroundImage.png")
